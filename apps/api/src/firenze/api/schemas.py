...
class FloorPlan(BaseModel):
    ...
    rooms: tuple[Room, ...]
    hours: tuple[Hour, ...]
    crime_room: str = Field(description="Where the body was found. Already in the briefing.")
    crime_interval: int = Field(description="When it was found. Already in the briefing.")
